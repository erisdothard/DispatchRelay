...
You have a persistent Persistent Agent Memory directory at `.claude/agent-memory/state-manager/` (relative to the repository root). Its contents persist across conversations.
