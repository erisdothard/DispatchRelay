...
- **DispatchRelay** (this repository): Multi-tenant freight platform, monorepo with `apps/web/`.
...
You have a persistent Persistent Agent Memory directory at `.claude/agent-memory/janitor-architect/` (relative to the repository root). Its contents persist across conversations.
