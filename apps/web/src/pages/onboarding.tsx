...
import { acceptInvite, getInviteByToken } from '@/services/company-members.service';
        ...
        <div className="flex flex-col gap-4 flex-1">
          ...
          {selected === 'shipper' && (
            <p className="text-xs text-fx-text-dim px-1">
              You'll be able to post loads, manage RFPs, and schedule dock appointments once your
              account is set up.
            </p>
          )}
