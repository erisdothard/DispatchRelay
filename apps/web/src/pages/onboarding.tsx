...
import {
  ...
  Mail, Lock, User, Building2, UserCheck, Users,
} from 'lucide-react';
        ...
        <div className="flex flex-col gap-4 flex-1">
          ...
          {selected === 'driver' && (
            <div className="bg-fx-orange/10 border border-fx-orange/20 rounded-2xl p-5 mb-2">
              ...
              <p className="text-sm text-fx-text-muted leading-relaxed">
                Ask your carrier to invite you from their <span className="text-fx-orange font-semibold">Team</span> page.
                Once invited, you'll automatically join their company and appear in their driver list.
              </p>
              <Button
                size="lg"
                fullWidth
          ...
          {selected === 'driver' && (
            <div className="flex items-center gap-3 my-1">
              ...
              <span className="text-xs text-fx-text-dim font-medium">or create your own company</span>
              <div className="flex-1 h-px bg-fx-border" />
            </div>
          )}
