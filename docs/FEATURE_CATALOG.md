...
| Tire incident log (flat, blowout, low_pressure, damage)   | ✅     | Driver          | P2       | 14    | `pages/driver/tire-log.tsx`, `features/driver/components/tire-incident-form.tsx`, `services/tire-incidents.service.ts`, `database/migrations/043-flat-tire-log.sql` |
